...
if (isset($_POST['update'])) {
  ...
  $data->setrequestfor($_POST['requestfor']);
  ...
  if (!$update) {
    ...
    try {
      ...
      //Content
      $mail->isHTML(true);
      $mail->Subject = $subject = "EMMC MAINTENANCE SYSTEM - REQUEST COMPLETED";
      ...
      $mail->Body = $message = "<img src='https://loader.exel-portal.com/repairs.gif' height='200'><br>" .
        "We are informing you that your request has been successfully accomplished by EMMC Maintenance Team. 
This message serves as a confirmation that the task you submitted has been completed and resolved.</h4>" .
        "Successfully Done Request!<br><br></h4>"
        . "<table style='border: 1px solid #ccc; width:50%;'>
<tr>
<td style='border: 1px solid #ccc; background-color: #eaecf4;'>MWO#: </td>
<td style='border: 1px solid #ccc; background-color: #eaecf4;'>" . $data->getId($_POST['id']) . "</td>
</tr>
<tr>
<td style='border: 1px solid #ccc; background-color: #eaecf4;'>RequestFor: </td>
<td style='border: 1px solid #ccc; background-color: #eaecf4; white-space: normal !important;'>" . $data->getrequestfor($_POST['requestfor']) . "</td>
</tr>
<tr>
<td style='border: 1px solid #ccc; background-color: #eaecf4;'>Request&nbsp;Description: </td>
<td style='border: 1px solid #ccc; background-color: #eaecf4; white-space: normal !important;'>" . $data->getremarks($_POST['remarks']) . "</td>
</tr>
<tr>
<td style='border: 1px solid #ccc; background-color: #eaecf4;'>Status: </td>
<td style='border: 1px solid #ccc; background-color: #eaecf4;'> " . $statusText . "</td>
</tr>
<tr>
<td style='border: 1px solid #ccc; background-color: #eaecf4;'>Date&nbsp;Request: </td>
<td style='border: 1px solid #ccc; background-color: #eaecf4;'> " . date('m-d-Y', strtotime($data->getdate_request($_POST['date_request']))) . "</td>
</tr>
<tr>
<td style='border: 1px solid #ccc; background-color: #eaecf4;'>Date&nbsp;End:  </td>
<td style='border: 1px solid #ccc; background-color: #eaecf4;'> " . date('m-d-Y', strtotime($data->getdate_finish($_POST['date_finish']))) . "</td>
</tr>
<tr>
<td style='border: 1px solid #ccc; background-color: #eaecf4;'>Description&nbsp;of&nbsp;Completed Work:  </td>
<td style='border: 1px solid #ccc; background-color: #eaecf4; white-space: normal !important;'> " . $data->getfeedback($_POST['feedback']) . "</td>
</tr>
</table>" .
