      ...
      <br>
        ...
        <div class="container-fluid" id="container-wrapper">
          ...
          <div class="row mb-3">
            ...
            <div class="col-xl-3 col-md-6 mb-4">
            <a href="new_request.php" class="link">
              <div class="card h-100">
                <div class="card-body">
                  <div class="row no-gutters align-items-center">
                    <div class="col mr-2">
            ...
            <div class="col-lg-12">
              ...
              <div class="card mb-4">
                ...
                <div class="loader">
                  ...
                  <form action="private/requestProcess.php" method="POST" autocomplete="off">
                  ...
                  <!-- <div class="form-group" id="simple-date1">
                    ...
                    <div class="rightbtn"><button type="submit" name="btnsubmit" class="btn btn-primary">Submit</button></div>
                  </form>
                </div>
              </div>
            <div class="col-lg-12">
