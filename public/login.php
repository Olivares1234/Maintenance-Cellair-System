      ...
      <div class="main">
        <form action="config/login_config.php" method="POST" autocomplete="off">
          ...
          <span>
            ...
            <span class="show-pass"><i class="fas fa-eye" aria-hidden="true" id="eye-show-pass"
          ...
          <!-- <span>
            <em style="font-size:1.1em;">Create account?<a href="register" style="color:#fff; font-size:1.1em">Register
                here</a></em>
          </span> -->
        </form>
      </div>
